...
if (process.env.NODE_ENV == undefined || process.env.NODE_ENV == "development") {
  ...
  config.instagram.oauth_callback_url = "https://www.proxigram.com/auth/instagram/callback";
  config.instagram.connect_oauth_callback_url = "https://www.proxigram.com/connect/instagram/callback";
  config.instagram.realtime_callback_url = process.env.REALTIME_CALLBACK_URL;

  config.flickr.oauth_callback_url = "https://www.proxigram.com/auth/flickr/callback";
  config.flickr.connect_oauth_callback_url = "https://www.proxigram.com/connect/flickr/callback";
  config.flickr.push_callback_url = process.env.FLICKR_PUSH_CALLBACK_URL;

  config.facebook.oauth_callback_url = "https://www.proxigram.com/auth/facebook/callback";
  config.facebook.connect_oauth_callback_url = "https://www.proxigram.com/connect/facebook/callback";
  config.facebook.push_callback_url = process.env.FACEBOOK_PUSH_CALLBACK_URL;
